...
namespace ShopOnline.Data.Migrations
{
    ...
    [Migration("20210604091639_Add-ProductImage-Table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopOnline.Data.Entities.SYS_ACTION", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ShopOnline.Data.Entities.SYS_FEATURE", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ShopOnline.Data.Entities.SYS_LOG_ACTIVITY", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ShopOnline.Data.Entities.SYS_PERMISSION", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ShopOnline.Data.Entities.SYS_ROLE", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ShopOnline.Data.Entities.SYS_SETTING", b =>
                {
            ...
            modelBuilder.Entity("ShopOnline.Data.Entities.SYS_USER", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ShopOnline.Data.Entities.ORDER", b =>
                {
                    b.HasOne("ShopOnline.Data.Entities.SYS_USER", "SysUser")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("ShopOnline.Data.Entities.SYS_FEATURE", b =>
                {
                    b.HasOne("ShopOnline.Data.Entities.SYS_FEATURE", "ParentFeature")
            ...
            modelBuilder.Entity("ShopOnline.Data.Entities.SYS_PERMISSION", b =>
                {
                    b.HasOne("ShopOnline.Data.Entities.SYS_ACTION", "SysAction")
                        .WithMany("SysPermissions")
                        .HasForeignKey("SysActionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ShopOnline.Data.Entities.SYS_FEATURE", "SysFeature")
                        .WithMany("SysPermissions")
                        .HasForeignKey("SysFeatureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ShopOnline.Data.Entities.SYS_ROLE", "SysRole")
                        .WithMany("SysPermissions")
